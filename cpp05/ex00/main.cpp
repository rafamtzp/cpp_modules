...
int main()
{
    ...
    try {
        ...
        highFlyer.incrementGrade(); // Goes to 2
        std::cout << "Incremented: " << highFlyer << std::endl;
        
        highFlyer.incrementGrade(); // Goes to 1
        std::cout << "Incremented: " << highFlyer << std::endl;
        
        std::cout << "Attempting to breach grade 1 limit..." << std::endl;
        highFlyer.incrementGrade(); // Should throw!
        std::cout << "Success? " << highFlyer << std::endl; // Should not execute
    } 
    catch (const std::exception& e) {
        std::cout << "Caught exception: " << e.what() << std::endl;
    }
