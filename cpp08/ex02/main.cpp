...
{
	std::cout << "\n--- Test 4: Testing Const Iterators ---" << std::endl;
...
int main()
{
	...
	std::cout << "\n--- Test 2: Standard List Comparison with Test 1 ---" << std::endl;
	std::list<int> lstack;
	lstack.push_back(5);
	lstack.push_back(17);
	lstack.pop_back();
	...
	std::cout << "\n(Outputs from Test 1 and Test 2 should match exactly!)" << std::endl;

	std::cout << "\n--- Test 3: Reverse Iteration & Iterator Skipping ---" << std::endl;
	...
	std::cout << "\n--- Test 5: OCF, Copy and Assignment Operator ---" << std::endl;
	std::cout << "mstack size: " << mstack.size() << std::endl;
	std::cout << "mstack top: " << mstack.top() << std::endl;
	std::stack<int> s(mstack);
	std::cout << "Stack size from mutant copy: " << s.size() << std::endl;

	MutantStack<int> assignStack;
	assignStack = mstack;
	std::cout << "Assigned mutant stack top: " << assignStack.top() << std::endl;

	std::cout << "\n--- Test 6: Using Underlying Vector Container ---" << std::endl;
	...
	std::cout << "\n--- Test 7: Compatibility with std::sort ---" << std::endl;
